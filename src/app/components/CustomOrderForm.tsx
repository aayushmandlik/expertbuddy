  ...
  return (
    ...
    <div className="bg-gradient-to-br from-purple-600 to-purple-700 rounded-3xl p-6 shadow-lg max-w-xl mx-auto">
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        <div>
          ...
          <div className="relative">
            <select
              className="w-full bg-white rounded-md py-2 px-3 pr-8 appearance-none focus:outline-none text-gray-500"
              defaultValue=""
            >
      ...
      <div className="flex items-center justify-between">
        <div className="bg-white text-gray-400 rounded-md py-2 px-4 flex-grow mr-4">
